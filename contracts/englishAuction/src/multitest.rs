...
const NATIVE_DENOM: &str = "utestcore";
const USER: &str = "USER";
...
fn try_auction_queries() {
    ...
    assert_eq!(Auction {
        ...
        reserve_price: Some(coin(200u128 + n as u128, NATIVE_DENOM)),
        funds_recipient: None,
        highest_bid: Some(AuctionBid { price: coin(250u128, "utestcore".to_string()), bidder: bidder2.clone() }),
    ...
    assert_eq!(Auction {
        ...
        reserve_price: Some(coin(200u128 + n as u128, NATIVE_DENOM)),
        funds_recipient: None,
        highest_bid: Some(AuctionBid { price: coin(140u128, "utestcore".to_string()), bidder: bidder.clone() }),
    ...
    for n in 2..4 {
        let highest_bid = match n {
            3 => Some(AuctionBid { price: coin(250u128, "utestcore".to_string()), bidder: bidder2.clone() }),
            _ => None,
        };
        assert_eq!(Auction {
            token_id: n.to_string(),
